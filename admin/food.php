			...
			<div class="main_center main_center_r">
				...
				<div id="shopRight">
					...
					<tr>
						...
						<td class="center"><input type="text" size="4" name="order<?php echo  $rows['food_id']?>" value="<?php echo $rows['food_order']?>" /></td>
						<td class="center" style='padding:5px 0;'> <a href="foodedit.php?id=<?php echo $rows['food_id']?>&page=<?php echo $page?>">修改</a> 
						<a href="javascript:if(confirm('您确定要删除吗？')){location.href='shop_do.php?act=delfood&id=<?php echo $rows['food_id'];?>'}">删除</a></td>
					</tr>
						<?php
								}
						?>					
				...
				<p style="margin-bottom:10px;"><input type="image" src="../images/button/save.gif"/>
				<a href="javascript:if(confirm('您确定要删除吗？')){document.listForm.action='shop_do.php?&act=xxdel';document.listForm.submit();}"   title="删除"><img  src="../images/button/delete.gif" name="btnSave" /></a>		</p>

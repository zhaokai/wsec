			...
			<div class="main_center main_center_r">
				...
				<div id="shopRight">
					...
					<div id="introAdd">
						...
						<p><label>店铺名称:</label><input type="text" id="name" name="name" class="input input270" value="<?php echo $SHOP_INFOS['shop_name']?>" /> *</p>
						...
						<p><label>店铺电话:</label><input type="text" id="tel" name="tel" class="input input179" value="<?php echo $SHOP_INFOS['shop_tel']?>"/> *</p>
						...
						<p><label>店铺介绍:</label><textarea id="intro" name="intro" class="input input578" style="height:53px;resize:none;"><?php if(empty($SHOP_INFOS['shop_intro'])){echo '200字以内';}else{echo $SHOP_INFOS['shop_intro'];}?></textarea> *</p>

			...
			<div class="main_center main_center_r">
				...
				<div id="shopRight">
					...
					<div id="introAdd">
						...
						<p style="margin-left:12px;margin-bottom:10px;color:red;">小提示：设置送货时段，用户下订单时就可以选择送货时间。</p>
						...
						<?php 
							...
							if($num<=0){
								echo "<tr><td colspan='3' class='center'>亲，还没有添加送货时间段，赶紧添加吧！</td></tr>";
							}else{
